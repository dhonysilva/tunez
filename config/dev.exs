...
config :tunez, TunezWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "kVYCKqFChVEH3MO7H5unWTkaIt/DVb93JnaT7wJNmRNf2iSnWJ6u8cAA6i/0Ph+K",
  watchers: [
...
config :tunez, dev_routes: true, token_signing_secret: "EV93g3/Yf2r3uNjJrrr3ycyucE873hS8"
